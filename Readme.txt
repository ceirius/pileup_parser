"""
the following code was written for the University of Texas Southwestern for a bioinformatics core department. 

Requirements: Write a script in Perl or Python that parses the pileup file line-by-line, and will call a consensus base using two criteria: sequencing coverage and the proportion of consensus mismatches relative to the reference.  Call a consensus base if
